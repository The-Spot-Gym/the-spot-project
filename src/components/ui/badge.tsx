  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary: "border-0 bg-gradient-secondary text-secondary-foreground hover:opacity-90 font-medium",
        destructive: "border border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",
        outline: "border text-foreground",
        success: "border-0 bg-gradient-accent text-accent-foreground hover:opacity-90 font-medium",
      },
    },
    defaultVariants: {
      variant: "default",
